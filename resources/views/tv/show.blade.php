...
<div class="movie-info border-b border-gray-800">
  <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
    <img src="{{$tv['poster_path']}}" alt="parasite" class="w-64 md:w-96">
    <div class="md:ml-24">
              ...
              <div class="bg-gray-900 rounded">
                ...
                <div class="modal-body px-8 py-8">
                  <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                    <iframe width="560" height="315" class="responsive-iframe border-none absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{$tv['videos']['results'][0]['key']}}" allow="autoplay; encrypted-media" allow frameborder="0"></iframe>
                  </div>
                </div>
              </div>
            </div>
